...
// import { LOCATIONS, SPACE_CATEGORIES } from "../lib/data";
...
//     return location.workspaces.filter((s) => {
//       // Search across name, category, amenities
//       if (q) {
//         const hit =
...
//       if (availFilter === "available" && occupied) return false;
//       if (availFilter === "taken" && !occupied) return false;
//       // Favourites-only toggle
//       if (showFavoritesOnly && !favoriteIds.has(s.id)) return false;
//       return true;
//     });
//   }, [
//     location,
...
//               {location.workspaces.length} spaces across {location.floors}{" "}
...
export default function BookSpacePage() {
  ...
  const [occupiedIds, setOccupiedIds] = useState<Set<string>>(INITIAL_OCCUPIED);
